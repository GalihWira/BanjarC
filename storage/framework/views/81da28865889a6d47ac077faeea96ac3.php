...
<?php $__env->startSection('title', 'Validasi Pengajuan'); ?>

<?php $__env->startSection('validasiPengajuan'); ?>
    ...
    <main>
        ...
        <section class ="w-[1160px] h-[552px] bg-white ring-inset ring-[5px] ring-second-50 rounded-[14px] mt-[27px] mb-[25px] overflow-hidden">
            ...
            <div class ="grid-cols-5 ml-[5px] mt-2">
                <?php $__currentLoopData = $pengajuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengajuanc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class ="w-[1150px] h-fit flex items-center mb-2">
                <div class ="w-[73.77px] h-[43px] flex justify-center items-center">
                    <h1 class ="text-[17px] text-black"><?php echo e($pengajuanc['nomor']); ?></h1>
                </div>
                <div class ="w-[286px] h-fit flex justify-left items-center">
                    <h1 class ="text-[17px] text-black px-2"><?php echo e($pengajuanc['nama']); ?></h1>
                </div>
                <div class ="w-[270px] h-[43px] flex justify-left items-center">
                    <h1 class ="text-[17px] text-black px-2"><?php echo e($pengajuanc['pinjam']); ?></h1>
                </div>
                <div class ="w-[316px] h-[43px] flex justify-left items-center">
                    <h1 class ="text-[17px] text-black px-2"><?php echo e($pengajuanc['tanggal']); ?></h1>
                </div>
...
<?php echo $__env->make('layouts.sidbarUser', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Tugas Tugas Hevan\Universitas Udayana\07_FRONT END BACK END\KELOMPOK C (BANJAR DIGITAL)\BanjarC\resources\views/valpengajuan.blade.php ENDPATH**/ ?>