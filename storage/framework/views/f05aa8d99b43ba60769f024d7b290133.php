...
<?php $__env->startSection('title', 'Validasi Pembayaran'); ?>

<?php $__env->startSection('validasiPembayaran'); ?>
...
<body class ="font-sora bg-primary-50 px-[140px] pt-[34px] flex justify-center">
    <main>
        ...
        <section class ="w-[1160px] h-[400px] bg-second-50 mt-1 mb-[25px] px-[10px] py-3">
            ...
            <?php $__currentLoopData = $pembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembayaranc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            
            <div class ="flex mb-0.5">
            <div class ="w-[42px] h-10 bg-white mr-0.5 flex justify-center items-center">
                <h1 class ="font-sora font-bold text-primary-300 text-4"><?php echo e($pembayaranc['nomor']); ?></h1>
            </div>
            <div class ="w-[104px] h-10 bg-white mr-0.5 flex justify-center items-center">
                <h1 class ="font-sora font-bold text-primary-300 text-4"><?php echo e($pembayaranc['nib']); ?></h1>
            </div>
            <div class ="w-[284.86px] h-10 bg-white mr-0.5 flex items-center px-3">
                <h1 class ="font-sora font-bold text-primary-300 text-4"><?php echo e($pembayaranc['nama']); ?></h1>
            </div>
            <div class ="w-[229px] h-10 bg-white mr-0.5 flex items-center justify-between px-3">
                <h1 class ="font-sora font-bold text-primary-300 text-4"><?php echo e($pembayaranc['nominal']); ?></h1>
            ...
            <div class ="w-[221px] h-10 bg-white mr-0.5 flex items-center justify-center">
                <h1 class ="font-sora font-bold text-primary-300 text-4"><?php echo e($pembayaranc['tanggal']); ?></h1>
            </div>
...
<?php echo $__env->make('layouts.sidbarUser', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Tugas Tugas Hevan\Universitas Udayana\07_FRONT END BACK END\KELOMPOK C (BANJAR DIGITAL)\BanjarC\resources\views/valpembayaran.blade.php ENDPATH**/ ?>