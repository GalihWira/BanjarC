        ...
        <section class="w-[1282px] h-[641px] mt-[72px] bg-white rounded-[14px] drop-shadow-[7px_8px_4.1px_rgba(0,0,0,0.5)] flex flex-col items-center pt-[39px] -mt-2">
            ...
            <div class="rounded-t-[13px] w-280 h-15 bg-second-50 border border-black">
                ...
                <div class="border border-black bg-white w-280 h-33 flex flex-col items-center">
                    ...
                    <button class="mt-[8px] text-white bg-primary-300 border border-[#081E31] rounded-lg px-[43px] py-[4px]"> <a href="{{ route('pengad') }}">Buat Pengaduan</a></button>
                </div>
            </div>
            <div class="rounded-t-[13px] w-280 h-15 bg-second-50 border border-black mt-[154px]">
                ...
                <div class="border border-black bg-white w-280 h-33 flex flex-col items-center">
                    ...
                    <button class="mt-[8px] text-white bg-primary-300 border border-[#081E31] rounded-lg px-[43px] py-[4px]"> <a href="{{ route('pengajuan') }}">Ajukan Peminjaman</a></button>
                </div>
            </div>
        </section>
    </main>
