...
<body class='font-sora bg-primary-50 mx-[150px] my-[61px]'>
    <main class='bg-white h-175 bg-center rounded-[20px] shadow-[4px_4px_10px_rgba(0,0,0,0.25)]'>
        <h1 class="text-primary-300 font-bold text-[48px] text-center pt-[34px]">Pengaduan Keluhan Banjar C</h1> 
        <div class="bg-second-50 mx-[79px] mt-[20px] rounded-t-[10px] h-[42px] flex items-center justify-center">
            <h2 class="text-[16px] text-white">Untuk melakukan pengaduan silahkan melengkapi form di bawah ini</h2>
        </div>
        <div>
            ...
            <div class=" mx-[79px] mt-[10px] flex items-center justify-betweenn gap-[38px] grid grid-cols-3">
                ...
                <div>
                    <h6>Alamat Lengkap  <span class="text-red-500">*</span></h6> 
                    <input type="text" placeholder="Contoh: No.12, Gg.Int, Br.C" class="bg-input-50 rounded-[7px] mt-[4.7px] text-[16px] h-[31.25px] w-full pl-[12.5px] shadow-[1.4px_1.4px_2px_rgba(0,0,0,0.25)]">
                </div>
            </div>
            <div class="bg-primary-50 h-[34.37px] ml-[79px] w-[213.91px] rounded-[13px] mt-[28.69px] flex items-center justify-center gap-[5px] font-semibold">
                ...
                <h7 class="text-primary-300 text-[18px] ">Detail Pengaduan</h7>
            </div>
            <div class=" mx-[79px] mt-[10px] flex justify-betweenn gap-[38px] grid grid-cols-3 mb-[10px]">

                <div>
                    <div>
                        <h8 class="text-[16.5px]">Subjek Pengaduan <span class="text-red-500">*</span></h8>
                        <input type="text" placeholder="Contoh : Jalan Berlubang" class="bg-input-50 rounded-[7px] mt-[4.7px] text-[16px] h-[31.25px] w-full pl-[12.5px] shadow-[1.4px_1.4px_2px_rgba(0,0,0,0.25)]">
                    </div>
                    <div class="mt-[10px]">
                        <h8 class="text-[16.5px]">Kategori <span class="text-red-500">*</span></h8>
                ...
                <div>
                    <div>
                        <h8 class="text-[16.5px]">Tanggal <span class="text-red-500">*</span></h8>
                    ...
                    <div class="mt-[10px]">
                        <h9 class="text-[16.5px]">Upload Bukti (Opsional)</h9>
                ...
                <div>
                    <h10 class="text-[16.5px]">Keterangan Pengaduan <span class="text-red-500">*</span></h10>
                    <input type="text" placeholder="" class="bg-input-50 rounded-[7px] mt-[4.7px] top-0 text-[16px] h-[105px] w-full pl-[12.5px] shadow-[1.4px_1.4px_2px_rgba(0,0,0,0.25)] placeholder:align-top">
                </div>
            </div>
    
            <h12 class="text-[16px] font-extralight mx-[79px]">Kolom bertanda bintang (<span class="text-red-500">*</span>) wajib diisi</h12>
            <div class="flex items-center justify-between mx-[79px] gap-[820px] mt-[74px] font-bold text-[16px]">
                <button class="w-1/2 ">
                    <a href="{{ route('awalpp') }}" class="text-white bg-second-50 rounded-[15px] w-full h-[37.35px] flex items-center justify-center shadow-[0px_3px_3px_rgba(0,0,0,0.25)]">Batal</a>
                </button>
                 <button class="w-1/2">
